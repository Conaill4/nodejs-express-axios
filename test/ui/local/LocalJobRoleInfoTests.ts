...
describe('Job Role Info Page Tests - Local', () => {
    ...
    describe('Local - correct role page for software engineer', () => {
        it('When role name link is clicked, the role info page should be for the correct role - Software Engineer', async () => {
            ...
            expect(infoPageURL).to.equal('http://localhost:3000/job-roles/1');
            expect(infoPageRole).to.equal(roleOneButtonText);

        })
    })

    describe('Local - correct role page for Tester', () => {
        it('When role name link is clicked, the role info page should be for the correct role - Tester', async () => {
            ...
            // Compare URL and role name to expected
            expect(infoPageURL).to.equal('http://localhost:3000/job-roles/2');
    ...
    describe('Local - Job Role Details Page should return correct values in each for software engineer(id = 1)', () => {
    ...
    describe('Local - Non numeric endpoint - correct redirect and error message', async ()=>{
        it('If a user goes to an endpoint of an invalid ID - they should be directed to the job role list', async ()=>{
            // Navigate to endpoint with invalid ID (doesn't exist in DB)
    ...
    describe('Local - Working back button', ()=>{
